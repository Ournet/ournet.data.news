...
function normalizeWebpage(webpage) {
	...
	webpage.id = id;
	webpage['title_' + webpage.lang] = utils.atonic(webpage.title);
	webpage['summary_' + webpage.lang] = utils.atonic(webpage.summary.substr(0, 200));
