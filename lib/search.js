 ...
 * Create a webpage
 */
external.createWebPage = function(webpage) {
 ...
 * Update a webpage
 */
external.updateWebPage = function(id, data) {
 ...
 * Search webpages
 */
external.searchWebPages = function(params) {
	...
	return client.searchAsync({
		...
		type: ES_PAGES_TYPE,
		body: body
	}).then(internal.getWebPages);
};

internal.normalizeWebpage = function(webpage) {
...
internal.getWebPages = function(response) {
	var items = [];
