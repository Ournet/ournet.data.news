...
Service.prototype.website = function(params) {
	...
	return this.one('Website', params);
};
...
Service.prototype.countWebsites = function(params) {
	assert.ok(params);

	return this.count('Website', params);
};

Service.prototype.feed = function(params) {
	assert.ok(params);

	return this.one('Feed', params);
};
...
Service.prototype.countFeeds = function(params) {
	assert.ok(params);

	return this.count('Feed', params);
};
